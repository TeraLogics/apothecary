  ...
  def releases do
    [
      apothecary: [
        ...
        applications: [inets: :permanent, ssl: :permanent, runtime_tools: :permanent],
        steps: [:assemble, &copy_bin_start_boot/1]
      ]
    ]
  end

  # https://github.com/elixir-lang/elixir/issues/9286
  # this is needed to run mix cmds from our release.
  # the above issue details why it's needed
